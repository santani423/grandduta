...
class Cicilan_model extends CI_Model {
	 ...
	 */
	function get_tagihan_pertama_buat_cicil($nosl)
	{
		$sql = "exec caltagihanterawal " . date('j') . ",$nosl";
			
		return $this->db->query($sql);
	}
	
	function get_tagihan_pertama_buat_cetakcicil($nosl)
	{
		$sql = "exec caltagihanterawal " . date('j') . ",$nosl";
