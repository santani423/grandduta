 ...
 */
class Nextapp extends CI_Controller {
	/**
	 * Constructor
	 */
	function nextapp()
	...
	function main()
	{
		...
		$data['h2_title'] = 'Next Application';
		...
		$data['main_view'] = 'nextapp/deskripsi';
		$data['left_view'] = 'menunext.php';
