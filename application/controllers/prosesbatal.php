 ...
 */
class Prosesbatal extends CI_Controller {
	/**
	 * Constructor
	 */
	...
	function main()
	{
		...
		$data['main_view'] = 'batal/prosesbatal_view';
		$data['left_view'] = 'menubatal.php';
		$data['form_action'] = 'prosesbatal/get_transaksi';
