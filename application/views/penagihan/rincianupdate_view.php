            ...
            <tbody>
              ...
              <tr>
               ...
               <td><center> 
                   <?php
               			 echo anchor(
                            site_url('update_tagihan/tampilaprove/' .$tagihan['idtagihan']),
                                       '<i class="glyphicon glyphicon-edit"></i>',
                                       'class="btn btn-sm btn-info" data-tooltip="tooltip" data-placement="top" title="Edit Data"'
                                      );
                   ?>
                   <?php
                         echo anchor(
                   			site_url('update_tagihan/destroy/' .$tagihan['idtagihan']),
    ...
    <div class="panel-footer">   
          <div class="row"> 
              <div class="col-md-10 col-sm-12 col-md-offset-2 col-sm-offset-0">
                   <a href="<?php echo site_url('update_tagihan'); ?>" class="btn btn-default">
