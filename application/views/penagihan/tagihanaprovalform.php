                ...
                <div class="col-sm-6">                                   
                  <?php                  
                   echo form_dropdown(
                           'cbokenadiskon',
                           $isikenadiskon,  
                           set_value('kenadiskon',isset($default['kenadiskon']) ? $default['kenadiskon'] : ''),
                           'class="form-control input-sm "  id="kenadiskon"'
                           );             
                  ?>
                 <?php echo form_error('kenadiskon');?>
                </div>
              </div> <!--/ cbobork -->
                ...
                <div id="desadd" class="col-sm-6">                                   
                  <?php                  
                   echo form_dropdown(
                           'cbokenadenda',
                           $isikenadenda,  
                           set_value('kenadenda',isset($default['kenadenda']) ? $default['kenadenda'] : ''),
                           'class="form-control input-sm "  id="kenadenda"'
                           );             
                  ?>
                 <?php echo form_error('kenadenda');?>
                </div>
              </div> <!--/ IdKab -->
              
             <div class="form-group">
                   <label for="cbocluster" class="col-sm-2 control-label">Keterangan Approval</label>
                <div class="col-sm-6">                                   
                  <?php                  
                   echo form_textarea(
                                array(
                                 ...
                                 set_value('keterangan',isset($default['keterangan']) ? $default['keterangan'] : '')
                           );             
                  ?>
                 <?php echo form_error('bulan');?>
                </div>
