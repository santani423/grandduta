...
<body>
<form name="masa_form" method="post" action="<?php echo $form_action; ?>">
	<p>
	...
	<p>
	  <label for="kodenkl">Kode N/K/L | Nominal :</label>
		...
		<?php echo form_error('nominalkodenkl', '<p class="field_error">', '</p>');?>
	...
	<p>
	  <label for="restkompen">Restitusi/Kompensasi | Nominal :</label>
		...
		<?php echo form_error('nominalrestkompen', '<p class="field_error">', '</p>');?>
