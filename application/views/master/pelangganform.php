    ...
    <div class="panel-heading"><i class="glyphicon glyphicon-signal"></i> </div>
      ...
      <div class="panel-body">
             ...
             <div class="form-group">
              ...
              <div class="form-group">
                   <label for="nohp" class="col-sm-2 control-label">Nomor HP</label>
                <div class="col-sm-6">                                   
                  <?php                  
                   echo form_input(
                                array(
                ...
                <div class="form-group">
                   <label for="notlp" class="col-sm-2 control-label">Nomor Telpon</label>
                <div class="col-sm-6">                                   
                  <?php                  
                   echo form_input(
                                array(
                                 ...
                                 set_value('notelpon',$pelanggan['notelpon'])
                           );             
                  ?>
                  ...
                  <?php                  
                   echo form_input(
                                array(
                                 ...
                                 set_value('alamatktp',$pelanggan['alamatktp'])
                           );             
                  ?>
                 <?php echo form_error('alamatktp');?>
                </div>
              </div> <!--/ Alamat KTP -->              
                          
              <div class="form-group">
                   <label for="cbokab" class="col-sm-2 control-label">Kabupaten</label>
                <div id="desadd" class="col-sm-6">                                   
                  <?php                  
                   echo form_dropdown(
                           ...
                           $isikab,  
                           '',
                           'class="form-control input-sm "  id="idkab"'
                           );             
                  ?>
                 <?php echo form_error('idkab');?>
                </div>
              </div> <!--/ IdKab -->
              
               <div class="form-group">
                   <label for="cbokec" class="col-sm-2 control-label">Kecamatan</label>
                <div id="desadd" class="col-sm-6">                                   
                  <?php                  
                   echo form_dropdown(
                           'cbokec',
                           $isikec,  
                           set_value('idkecamatan',$pelanggan['idkecamatan']),
                           'class="form-control input-sm "  id="idkecamatan"'
                           );             
                  ?>
                  ...
                  <?php                  
                   echo form_input(
                                array(
                                 ...
                                 set_value('email',$pelanggan['email'])
                           );             
                  ?>
                ...
                <div class="col-sm-6">                                   
                  <?php                  
                   echo form_dropdown(
                           'cbostatushuni',
                           $isihuni,  
                           set_value('idhuni',$pelanggan['idhuni']),
                           'class="form-control input-sm "  id="idhuni"'
                           );             
                  ?>
                 <?php echo form_error('idhuni');?>
                </div>
              </div> <!--/ Status Pelanggan -->
              
              <div class="form-group">
                   <label for="cbostatus" class="col-sm-2 control-label">Status Pelanggan</label>
                <div class="col-sm-6">                                   
                  <?php                  
                   echo form_dropdown(
                           'cbostatusplg',
                           $isistatuspelanggan,  
                           set_value('idstatuspelanggan',$pelanggan['idstatuspelanggan']),
                           'class="form-control input-sm "  id="idstatuspelanggan"'
                           );             
                  ?>
                 <?php echo form_error('idstatusplg');?>
                </div>
              </div> <!--/ Status Pelanggan -->
    ...
    <div class="panel-footer">   
          <div class="row"> 
              <div class="col-md-10 col-sm-12 col-md-offset-2 col-sm-offset-0">
                   <a href="<?php echo site_url('master_pelanggan'); ?>" class="btn btn-warning">
