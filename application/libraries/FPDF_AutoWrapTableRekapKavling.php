...
class FPDF_AutoWrapTableRekapKavling extends FPDF {
private $data = array();
...
$this->Ln(10);
$this->SetFont("", "B", 15);
$this->SetX($left); $this->Cell(0, 14, 'DAFTAR TAGIHAN KAVLING', 0, 1,'C');
...
$this->SetX($left += 25); $this->Cell(55, $h, 'ID IPKL', 1, 0, 'C',true);
$this->SetX($left += 55); $this->Cell(180, $h, 'NAMA', 1, 0, 'C',true);
$this->SetX($left += 180); $this->Cell(110, $h, 'CLUSTER', 1, 0, 'C',true);

$this->SetX($left += 110); $this->Cell(70, $h, 'BLOK|KAV', 1, 0, 'C',true);
$this->SetX($left += 70); $this->Cell(70, $h, 'TAHUN', 1, 0, 'C',true);
$this->SetX($left += 70); $this->Cell(70, $h, 'BULAN', 1, 0, 'C',true);
$this->SetX($left += 70); $this->Cell(120, $h, 'TOTAL TAGIHAN', 1, 0, 'C',true);
$this->Ln(20);
 
$this->SetFont('Arial','',9);
$this->SetWidths(array(25,55,180,110,70,70,70,120));
$this->SetAligns(array('C','C','L','L','C','C','C','R'));
