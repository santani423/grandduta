...
$this->SetX($left += 50); $this->Cell(150, $h, 'NAMA PELANGGAN', 1, 0, 'C',true);

$this->SetX($left += 150); $this->Cell(40, $h, 'BLOK', 1,0, 'C',true);
$this->SetX($left += 40); $this->Cell(50, $h, 'NO KAV', 1, 0, 'C',true);

$this->SetX($left += 50); $this->Cell(100, $h, 'TELPON / HP', 1, 0, 'C',true);
$this->SetX($left += 100); $this->Cell(80, $h, 'HUNI?', 1, 0, 'C',true);

$this->SetX($left += 80); $this->Cell(75, $h, 'THN MULAI', 1, 0, 'C',true);
$this->SetX($left += 75); $this->Cell(75, $h, 'BLN MULAI', 1, 0, 'C',true);

$this->SetX($left += 75); $this->Cell(60, $h, 'JML BLN', 1, 0, 'C',true);
$this->SetX($left += 60); $this->Cell(100, $h, 'TOTAL TAGIHAN', 1, 0, 'C',true);
$this->Ln(40);
 
$this->SetFont('Arial','',9);
$this->SetWidths(array(50,150,40,50,100,80,75,75,60,100));
$this->SetAligns(array('C','L','C','C','C','C','C','C','C','R'));
...
(
		array
		(
			'','Grand Total','','','','','','','',$this->separator($grandtotal)
		)
);
