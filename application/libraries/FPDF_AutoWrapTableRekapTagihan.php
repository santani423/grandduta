...
$this->Ln(10);
$this->SetFont("", "B", 15);
$this->SetX($left); $this->Cell(0, 14, 'REKAP TAGIHAN', 0, 1,'C');
...
$this->SetX($left += 90); $this->Cell(94, $h, '3 BULAN LEBIH', 1, 0, 'C',true);
$this->SetX($left += 94); $this->Cell(100, $h, 'TOTAL TAGIHAN', 1, 0, 'C',true);
$this->Ln(20);
 
$this->SetFont('Arial','',9);
$this->SetWidths(array(25,45,120,90,70,70,80,90,94,100));
$this->SetAligns(array('C','C','C','L','C','R','R','R','R','R'));
