...
class FPDF_AutoWrapTableLaporanBulananLalu extends FPDF {
private $data1 = array();
...
'orientation'=>'L'
	...
	function __construct($data1 = array(), $options = array()) {
		parent::__construct();
		$this->data1 = $data1;
...
$this->Ln(10);
$this->SetFont("", "B", 15);
$this->SetX($left); $this->Cell(0, 14, 'LAPORAN BULANAN TAGIHAN DAN PENERIMAAN BULAN LALU', 0, 1,'C');
...
$this->SetAligns(array('C','C','R','R','R','C'));
...
foreach ($this->data1 as $baris)
{
	...
	$piutang=$piutang+$baris->piutangbulanlalu;
	...
	$this->separator($baris->piutangbulanlalu),
	$this->separator($baris->efisiensibulanlalu)
	));
