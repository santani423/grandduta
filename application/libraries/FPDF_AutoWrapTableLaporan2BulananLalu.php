...
class FPDF_AutoWrapTableLaporan2BulananLalu extends FPDF {
private $data2 = array();
...
'orientation'=>'L'
	...
	function __construct($data2 = array(), $options = array()) {
		parent::__construct();
		$this->data2 = $data2;
...
$this->Ln(10);
$this->SetFont("", "B", 15);
$this->SetX($left); $this->Cell(0, 14, 'LAPORAN BULANAN TAGIHAN DAN PENERIMAAN DUA BULAN LALU', 0, 1,'C');
...
{
	$tagihanbulanlalu=$tagihanbulanlalu+$baris->tagihan2bulanlalu;
	$penerimaanbulanlalu=$penerimaanbulanlalu+$baris->penerimaan2bulanlalu;
	$piutang=$piutang+$baris->piutang2bulanlalu;
	...
	$this->separator($baris->piutang2bulanlalu),
	$this->separator($baris->efisiensi2bulanlalu)
	));
